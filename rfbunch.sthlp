...
{p 10 15 2}
{cmd:rfbunch} {depvar} [{indepvars}] {cmd:,} cutoff(real) bw(real) [limits(numlist) notch(numlist) kink(numlist) tcr(numlist) pol(numlist) adjust(string) constant]
...
rfbunch first estimates polynomial density estimates of the counterfactual density
 ...
 mass above the cutoff is equal to the excess mass in the bunching region, eother 
...
{phang}
Andresen, M. and Thorvaldsen, L. (2021) Estimating the tax elasticity of firm debt: What can we learn from bunching?, working paper

{phang}
Chetty, Raj, John N. Friedman, Tore Olsen, and Luigi Pistaferri. 2011. Adjustment Costs, Firm Responses, and Micro vs. Macro Labor
Supply Elasticities: Evidence from Danish Tax Records. Quarterly Journal of Economics 126(2): 749-804.

{phang}
Kleven, H. 2016. Bunching. Annual Review of Economics Vol. 8:435-464

{phang}
Kleven, H. and Waseem, M. (2013) Using notches to uncover optimization frictions and structural elasticities: Theory and evidence from Pakistan.

{phang}
Saez, E. 2010. Do Taxpayers bunch at kink points? American Economic Journal: Economic Policy 2 (August 2010): 180–212


{title:Thanks for citing rfbunch as follows}

{pstd}
Andresen, Martin E., (2021). "RFBUNCH: Stata module to estimate reduced form bunching and structural parameters with multiple response variables.". This version VERSION_DATE.{p_end}
